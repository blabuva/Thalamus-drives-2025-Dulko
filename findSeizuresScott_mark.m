function seizures = findSeizuresScott_mark(varargin) %pband, ptCut, ttv, eegChannel, targetFS)
...
addParameter(p,'pzit',default_pzit);
...
pzit = p.Results.pzit ;
detectionParameters(1,:) = {'pband','ptCut','ttv','eegChannel','targetFS','pzit'};
detectionParameters(2,:) = {pband,ptCut,ttv,eegChannel,targetFS,pzit};
...
startEnd_interp(isnan(startEnd_interp))=0;
